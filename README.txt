...
cmdflow — это утилита для Linux, которая подсчитывает ваши команды Fish/Bash, создаёт топ-N команд и выводит его в термин[...]
...
Удобно для анали��а вашей командной истории
